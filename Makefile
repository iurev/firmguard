...
test:
	@go test -v ./internal/api/... ./internal/service/... ./internal/worker/...

race:
	@go test -race -v ./internal/api/... ./internal/service/... ./internal/worker/...

coverage:
	@go test -coverprofile=coverage.out ./internal/api/... ./internal/service/... ./internal/worker/...
